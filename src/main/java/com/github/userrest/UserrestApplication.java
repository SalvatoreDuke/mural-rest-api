...
public class UserrestApplication {
	...
	public static void main(String[] args) {
        ...
        var mensagemRepository = context.getBean(MensagemRepository.class);
        if (mensagemRepository.count() == 0) {
            logger.info("Nenhuma mensagem encontrada, adicionando exemplos ao mural");
            mensagemRepository.save(new Mensagem("João Silva", "Bem-vindos ao Mural de Recados!"));
            mensagemRepository.save(new Mensagem("Maria Souza", "Reunião do projeto marcada para sexta-feira às 14h."));
            mensagemRepository.save(new Mensagem("Carlos Oliveira", "Alguém encontrou um pendrive na sala 3?"));
        }
